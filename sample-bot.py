...
def main():
    ...
    while True:
        ...
        if (timer%10)==0:
        # Penny Pinching
            exchange.send_add_message(order_id=timer, symbol="BOND", dir=Dir.BUY, price=999, size=5)
            exchange.send_add_message(order_id=timer+1, symbol="BOND", dir=Dir.SELL, price=1001, size=5)
